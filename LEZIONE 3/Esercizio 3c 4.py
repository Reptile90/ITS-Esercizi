...
match animali:
    case "cane"|"gatto"|"cavallo"|"elefante"|"leone":
        print(f"{animali} appartiene alla categoria dei Mammiferi")
    case "serpente"|"lucertola"|"tartaruga"|"coccodrillo":
        print(f"{animali} appartiente alla categoria dei Rettili")
    case "aquila"|"pappagallo"|"gufo"|"falco":
        print(f"{animali} appartiene alla categoria degli Uccelli")
    case "squalo"|"trota"|"salmone"|"carpa":
        print(f"{animali} appartiene alla categoria dei Pesci")
    case _:
